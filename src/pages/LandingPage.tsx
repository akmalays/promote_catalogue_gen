...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-stone-950 text-stone-900 dark:text-stone-100 font-sans antialiased relative overflow-x-hidden">
      <BackgroundPattern />

      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-white/90 dark:bg-stone-950/80 backdrop-blur-xl border-b border-stone-100 dark:border-stone-800/60">
        <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 md:gap-2">
            <button
              ...
              className="px-3 py-2 text-sm font-medium text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white transition-colors hidden sm:inline-flex items-center gap-1.5"
            >
              Tools
              <span className="text-[9px] px-1.5 py-0.5 bg-amber-100 text-amber-700 dark:bg-amber-400/15 dark:text-amber-300 rounded font-semibold">Gratis</span>
            </button>
            <ThemeToggle />
            <button
              onClick={() => navigate('/login')}
              className="px-3 md:px-4 py-2 text-sm font-medium text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white transition-colors"
            >
              Masuk
            </button>
            <button
              onClick={() => navigate('/signup')}
              className="px-4 py-2.5 bg-stone-900 dark:bg-white text-white dark:text-stone-950 rounded-lg text-sm font-medium hover:bg-stone-800 dark:hover:bg-stone-100 transition-colors dark:shadow-lg dark:shadow-amber-500/10"
            >
              Daftar
            </button>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                onClick={() => navigate('/signup')}
                className="px-6 py-3 bg-stone-900 dark:bg-white text-white dark:text-stone-950 rounded-xl text-sm font-semibold hover:bg-stone-800 dark:hover:bg-stone-100 transition-all hover:shadow-lg hover:shadow-stone-900/10 dark:hover:shadow-amber-500/20 flex items-center gap-2"
              >
                Coba sekarang <ArrowRight className="w-4 h-4" />
              </button>
              <button
                onClick={() => navigate('/login')}
                className="px-6 py-3 bg-stone-100 dark:bg-stone-900/70 dark:backdrop-blur-sm border border-transparent dark:border-stone-800 text-stone-700 dark:text-stone-200 rounded-xl text-sm font-semibold hover:bg-stone-200 dark:hover:bg-stone-900 dark:hover:border-stone-700 transition-colors"
              >
                Sudah punya akun
              </button>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
              {HIGHLIGHTS.map((h, i) => (
                <span key={i} className="inline-flex items-center gap-1.5 text-xs text-stone-400 dark:text-stone-500 font-medium">
                  {h.icon} {h.text}
                </span>
              ))}
            </div>
      ...
      <section className="py-16 md:py-24 relative bg-stone-50/70 dark:bg-transparent border-y border-stone-100 dark:border-stone-800/60">
        <div className="max-w-5xl mx-auto px-6 relative">
            ...
            {PREVIEW_MENUS.map((menu, i) => (
              <button
                ...
                className={cn(
                  ...
                  activeMenu === i
                    ? 'bg-stone-900 dark:bg-white text-white dark:text-stone-950 shadow-sm dark:shadow-lg dark:shadow-amber-500/10'
                    : 'bg-white dark:bg-stone-900/60 dark:backdrop-blur-sm border border-stone-200 dark:border-stone-800 text-stone-500 dark:text-stone-400 hover:text-stone-700 dark:hover:text-white hover:border-stone-300 dark:hover:border-stone-700',
                )}
              >
                {menu.label}
              </button>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeImage === i
                      ...
                      : 'text-stone-400 dark:text-stone-500 hover:text-stone-600 dark:hover:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-900/50',
                  )}
                >
          ...
          <div className="relative rounded-xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900/50 dark:backdrop-blur-sm p-1.5 shadow-lg shadow-stone-200/30 dark:shadow-2xl dark:shadow-black/40 overflow-hidden">
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
              <span className="px-2.5 py-1 bg-white/90 dark:bg-stone-950/80 backdrop-blur-sm border border-stone-200 dark:border-stone-800 rounded-md text-[11px] font-medium text-stone-600 dark:text-stone-300 shadow-sm">
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-stone-500 dark:text-stone-400 max-w-md mx-auto">
              Kumpulan kalkulator gratis untuk bantu kelola bisnis kamu — retail, kafe, warung, atau jasa.
            </p>
          </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white dark:bg-stone-900/70 dark:backdrop-blur-xl border border-stone-200 dark:border-stone-800 rounded-2xl p-6 md:p-8 shadow-sm dark:shadow-2xl dark:shadow-black/40"
          >
            ...
            <button
              onClick={() => navigate('/tools')}
              className="w-full px-5 py-3 bg-stone-900 dark:bg-white text-white dark:text-stone-950 rounded-xl text-sm font-semibold hover:bg-stone-800 dark:hover:bg-stone-100 transition-colors inline-flex items-center justify-center gap-2"
            >
        ...
        <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-stone-900 dark:bg-white text-white dark:text-stone-950 flex items-center justify-center text-sm font-bold dark:shadow-lg dark:shadow-amber-500/20">
                  {s.step}
                </div>
                <h3 className="text-sm font-semibold mb-1 text-stone-900 dark:text-white">{s.title}</h3>
                <p className="text-xs text-stone-500 dark:text-stone-400 leading-relaxed max-w-[200px] mx-auto">{s.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-20 md:py-24 relative bg-stone-900 dark:bg-transparent">
        <div className="max-w-2xl mx-auto px-6 text-center relative">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="dark:bg-stone-900/70 dark:backdrop-blur-xl dark:border dark:border-stone-800 dark:rounded-3xl dark:p-10 dark:md:p-14 dark:shadow-2xl dark:shadow-black/40 relative overflow-hidden"
          >
            <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-amber-500/[0.08] blur-3xl pointer-events-none hidden dark:block" />
            ...
            <div className="relative">
              ...
              <button
                onClick={() => navigate('/signup')}
                className="px-7 py-3 bg-white text-stone-900 rounded-xl text-sm font-semibold hover:bg-stone-100 transition-colors inline-flex items-center gap-2 dark:shadow-lg dark:shadow-amber-500/20"
              >
      ...
      {/* Footer */}
      <footer className="border-t border-stone-100 dark:border-stone-800/60 py-6 relative">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <img src={logoAsset} alt="myStore" className="w-5 h-5 object-contain opacity-60" />
            <span className="text-xs text-stone-400 dark:text-stone-500">© {new Date().getFullYear()} myStore</span>
          </div>
          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/tools')} className="text-xs text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 transition-colors">
              Tools Gratis
            </button>
            <button onClick={() => navigate('/login')} className="text-xs text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 transition-colors">
              Masuk
            </button>
            <button onClick={() => navigate('/signup')} className="text-xs text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 transition-colors">
              Daftar
            </button>
          </div>
        </div>
...
// ============================================================
// BackgroundPattern — visible only in dark mode
// ============================================================
    ...
    <section className="pb-20 md:pb-28 relative">
      <div className="max-w-5xl mx-auto px-6">
        <motion.div
          ...
          className="relative rounded-2xl border border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-900/60 dark:backdrop-blur-xl p-1.5 md:p-2 shadow-2xl shadow-stone-200/50 dark:shadow-black/50"
          onMouseEnter={() => setIsPaused(true)}
          onMouseLeave={() => setIsPaused(false)}
        >
          <div className="flex items-center gap-1.5 px-3 py-2.5 bg-white dark:bg-stone-900 rounded-t-xl border-b border-stone-100 dark:border-stone-800">
            <div className="w-2.5 h-2.5 rounded-full bg-stone-200 dark:bg-stone-700" />
            <div className="w-2.5 h-2.5 rounded-full bg-stone-200 dark:bg-stone-700" />
            <div className="w-2.5 h-2.5 rounded-full bg-stone-200 dark:bg-stone-700" />
            <div className="flex-1 mx-4 h-5 bg-stone-100 dark:bg-stone-800 rounded-md flex items-center px-2">
              <span className="text-[9px] text-stone-400 dark:text-stone-500 font-mono">mystore.app/{currentSlide?.id || 'dashboard'}</span>
            </div>
          </div>

          <div className="bg-white dark:bg-stone-950 rounded-b-xl overflow-hidden relative">
            <AnimatePresence mode="wait">
              <motion.div
                key={current}
                initial={{ opacity: 0 }}
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-3 px-3 py-1.5 bg-white/90 dark:bg-stone-950/80 backdrop-blur-md border border-stone-200 dark:border-stone-800 rounded-full shadow-sm dark:shadow-lg">
            {HERO_IMAGES.map((slide, i) => (
              ...
              >
                <div className={cn(
                  ...
                  current === i
                    ? 'w-5 bg-stone-900 dark:bg-amber-400'
                    : 'w-1.5 bg-stone-300 dark:bg-stone-700 group-hover:bg-stone-500',
                )} />
                {current === i && (
          ...
          {!isPaused && (
            <div className="absolute bottom-0 left-2 right-2 h-0.5 bg-stone-100 dark:bg-stone-800 rounded-full overflow-hidden">
              <motion.div
                key={current}
                initial={{ width: '0%' }}
                animate={{ width: '100%' }}
                transition={{ duration: SLIDE_INTERVAL / 1000, ease: 'linear' }}
                className="h-full bg-stone-400 dark:bg-amber-400 rounded-full"
              />
            </div>
          )}
        </motion.div>
      ...
      {showPlaceholder && (
        <div className="absolute inset-0 bg-stone-100 dark:bg-stone-900 flex flex-col items-center justify-center gap-2 rounded-lg">
          <div className="w-10 h-10 rounded-lg bg-stone-200 dark:bg-stone-800 dark:border dark:border-stone-700 flex items-center justify-center">
            <ImageIcon className="w-5 h-5 text-stone-400 dark:text-stone-600" />
          </div>
...
function ToolPreview({ label }: { label: string }) {
  return (
    <div className="flex items-center justify-center px-3 py-3 bg-stone-50 dark:bg-stone-950/60 border border-stone-200 dark:border-stone-800 rounded-xl text-center">
