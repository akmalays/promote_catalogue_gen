...
export const PREVIEW_MENUS: PreviewMenu[] = [
  {
    ...
    images: [
      ...
      {id: "pembayaran", label: "Pembayaran", url: storageUrl("pos/pembayaran.webp")},
      {id: "settlement", label: "Cetak Settlement", url: storageUrl("pos/settlement.webp")},
    ],
  },
  {
    id: "inventory",
...
export const HERO_IMAGES = [
  ...
  {id: "cashier", label: "Kasir", url: storageUrl("hero/cashier.webp")},
